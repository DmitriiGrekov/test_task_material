...
<h1 class="my-md-5 my-4">Добавить ссылку</h1>
            <div class="row">
                <div class="col-lg-5 col-md-8">
                    <form action="{{route('material.store_link')}}" method='POST'>
                        @csrf
                        ...
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control" placeholder="Напишите авторов" value='{{old('link')}}' id="floatingAuthor" name='link'>
